...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      iconBg: "bg-log-error/15",
      iconColor: "text-log-error",
      borderColor: "border-log-error/30",
      glow: stats.error > 0,
    },
  ];
                ...
                filtered.slice(0, 30).map((log) => (
                  <tr
                    ...
                    className={`group border-b border-border/30 cursor-pointer transition-colors duration-100 ${
                      log.level === "ERROR"
                        ? "bg-log-error/[0.04] hover:bg-log-error/[0.08]"
                        : "hover:bg-surface-hover"
                    }`}
                  >
                    <td className="py-2.5 px-5 text-muted-foreground tabular-nums whitespace-nowrap">
                      {formatTimestamp(log.timestamp)}
                    </td>
                    <td className="py-2.5 px-4 font-medium text-primary whitespace-nowrap">
                      {log.serviceName}
                    </td>
                    ...
                    <td className="py-2.5 px-4">
                      <span
                        className={`inline-flex items-center gap-1.5 rounded-md px-2 py-0.5 text-xs font-semibold ${
                          log.level === "ERROR"
                            ? "bg-log-error/15 text-log-error"
                            : log.level === "WARN"
                            ? "bg-log-warn/15 text-log-warn"
                            : "bg-log-info/15 text-log-info"
                        }`}
                      >
                    ...
                    <td className="py-2.5 px-4 max-w-xs truncate text-foreground">
                      {log.message}
                    </td>
